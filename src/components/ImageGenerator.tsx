  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8 md:space-y-10">
      ...
      <div className={`space-y-8 ${activeTab === 'generate' ? '' : 'hidden'}`}>
        ...
        {image && !loading && (
          <>
            {/* label for generated content */}
            <h2 className="w-full text-center text-lg font-semibold text-white mb-2">
              Generated Content
            </h2>
            {provider === 'pollinations' && (
              <p className="w-full text-center text-xs text-zinc-500 mb-2">
                Generated by <a href="https://pollinations.ai" target="_blank" rel="noopener noreferrer" className="underline hover:text-zinc-300">Pollinations.ai</a>
              </p>
            )}
